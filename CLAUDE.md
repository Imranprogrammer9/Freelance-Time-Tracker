...
### Phase 4: Analytics + Ops  🚧 IN PROGRESS
- [x] PostHog events + Firebase Analytics — `AnalyticsManager` (ported from KMM starter, single native class) 2026-05-21
- [x] Crashlytics crash reporting — `AnalyticsManager.logError` (always on, not gated by analytics toggle) 2026-05-21
