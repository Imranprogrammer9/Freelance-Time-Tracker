...
Ask the user (wait for their answer): "Will this app call AI models?" If no, set
...
Ask the user (wait for their answer). Offer four buckets — each option's description shows
