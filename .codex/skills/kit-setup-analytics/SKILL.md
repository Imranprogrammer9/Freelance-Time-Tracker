...
- **All providers the dev cares about are already configured** — Ask the user
...
Ask the user (wait for their answer; multiple choices allowed) which the developer wants:
