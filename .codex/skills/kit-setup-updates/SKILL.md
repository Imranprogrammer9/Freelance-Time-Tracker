...
- **`REMOTE_CONFIG_PROVIDER` already non-LOCAL** — Ask the user (wait for their answer):
...
`RemoteAppConfig`. Ask the user (wait for their answer) — present these options exactly:
